 ...
 const Home = () => {
    ...
    <div className={` mx-auto px-4 py-10 mt-[60px] h-screen ${darkMode ? ' text-white' : 'bg-white text-gray-900'}`}>
      ...
      <div className="baner_part flex flex-col items-center text-center md:flex-row md:items-start md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start md:w-1/2 md:ml-10">
          <h1 className="text-3xl md:text-4xl font-bold pt-10 md:pt-20"> MD. Jahidul Islam</h1>
  ...
  <div className="absolute left-1/2 transform -translate-x-1/2 bottom-10 flex gap-4 ">
    <a className="social-icon w-10 h-10 bg-[#FF8A8A] rounded-md flex items-center justify-center transition duration-300 hover:bg-indigo-700 hover:text-yellow-300" 
     href="https://www.facebook.com/people/Jahidul-Islam/100083385545891/" 
     target="_blank" 
     rel="noopener noreferrer">
    <BsFacebook className="text-white text-lg" />
  </a>
  <a className="social-icon w-10 h-10 bg-[#FF8A8A] rounded-md flex items-center justify-center transition duration-300 hover:bg-indigo-700 hover:text-yellow-300" 
     href="https://github.com/md-jahid-islam/My-Portfolio-Website" 
     target="_blank" 
     rel="noopener noreferrer">
