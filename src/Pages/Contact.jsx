...
//           <h3 className="text-xl font-bold text-[#FF0075] flex items-center gap-2"><FaMapMarkerAlt /> Present Address</h3>
//           <p>Dhaka Uttara Azampur</p>
//         </div>

//         <div className="p-4 border rounded-lg shadow-lg hover:shadow-xl transition">
//           <h3 className="text-xl font-bold text-[#FF0075] flex items-center gap-2"><FaMapMarkerAlt /> Permanent Address</h3>
//           <p>Baniachong Habiganj Sylhet</p>
//         </div>

//         <div className="p-4 border rounded-lg shadow-lg hover:shadow-xl transition">
//           <h3 className="text-xl font-bold text-[#FF0075] flex items-center gap-2"><FaPhoneAlt /> Phone</h3>
//           <p>+8801540587085</p>
//         </div>

//         <div className="p-4 border rounded-lg shadow-lg hover:shadow-xl transition">
//           <h3 className="text-xl font-bold text-[#FF0075] flex items-center gap-2"><FaEnvelope /> Email</h3>
//           <p>jahidulislamweb2003@gmail.com</p>
//         </div>
//       </div>
...
//           <FaGithub />
//         </a>
//         <a href="https://www.facebook.com/jahidul.islam.98621" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-[#0866ff] text-3xl">
//           <FaFacebook />
//         </a>
//         <a href="https://www.linkedin.com/in/jahidul-islam-a5021b325/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-[#0866ff] text-3xl">
//           <FaLinkedin />
//         </a>
...
const Contact = () => {
      ...
      try {
        ...
        setTimeout(() => {
          const newMessage = {
            ...
            name: formData.name,
            message: formData.message,
            profileImage: formData.profileImage || "https://via.placeholder.com/50", // Default profile image
          };
          setMessages((prevMessages) => [
            ...prevMessages,
            newMessage,
            {
              ...
              profileImage: "https://via.placeholder.com/50", // Replace with your profile image URL
            },
          ]);
          toast.success("Message sent successfully! 📩");
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-16 text-center mt-20 relative">
      ...
      {/* Chat List and User Details part start */}
      {showChatList && (
        <div className="fixed bottom-20 right-5 w-80 h-96 bg-white border-2 border-gray-300 rounded-lg shadow-lg p-4 overflow-y-auto">
          <h3 className="text-xl font-bold text-[#FF0075] mb-3">Client Messages</h3>
            ...
            messages.map((msg) => (
              <div key={msg.id} className="border-b border-gray-200 mb-3 pb-2">
                <div className="flex items-center gap-2">
                  <img src={msg.profileImage} alt="User" className="w-8 h-8 rounded-full" />
      ...
      {/* Chat List and User Details part end */}
