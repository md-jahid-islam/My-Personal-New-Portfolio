...
//  const pages = ["/home", "/about", "/portfolio", "/blog", "/services", "/contact"];
...
//       {/* Loader */}
//       {loading && (
//         <div className="fixed inset-0 flex justify-center items-center bg-[#fff] dark:bg-[#789DBC] transition-all duration-1000 z-50">
...
//                 <NavLink to={path} className={({ isActive }) => `text-lg ${isActive ? "text-[#36C2CE]" : darkMode ? "text-[#A6E3E9]" : "text-[#222222]"} hover:text-[#36C2CE] transition-colors duration-300`}>
